...
const normalizeInstallationInput = (
  ...
  return {
    ...
    customerId: input.customerId || input.linkedCustomerId || previous?.customerId,
    siteId: input.siteId || input.linkedSiteId || previous?.siteId,
    linkedCustomerId: input.customerId || input.linkedCustomerId || previous?.linkedCustomerId || previous?.customerId || '',
    linkedSiteId: input.siteId || input.linkedSiteId || previous?.linkedSiteId || previous?.siteId || '',
    manufacturerCanonical: manufacturer,
    customerName,
    customerPhone,
    customerEmail,
